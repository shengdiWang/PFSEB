...
class SEB(object):
    ...
    def SEB_RTS0(self):
         ...
         df = pd.DataFrame({'date':self.dateRange2[:1], 
...
# df_cg[243:335].QE.mean()
# df_ori[243:335].QE.mean()
...
# df_cg[243:335].QH.mean()
# df_ori[243:335].QH.mean()
...
# df_cg[243:335].RTS0.mean()
# df_ori[243:335].RTS0.mean()
