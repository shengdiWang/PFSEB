function [wc, GRID, BALANCE] = CryoGridLateralWater( PARA, GRID, BALANCE, T, wc)
    ...
    if precondition_waterExchange
        ...
        water_fluxes=sum(water_fluxes_gather,3);
        
        waterflux=sum(water_fluxes(labindex,:))+boundary_water_flux;
